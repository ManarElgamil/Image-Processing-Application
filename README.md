...
- `archtiecture_drawio.png` - System architecture diagram
- `step function - screenshot.png` - Workflow visualization
- `image-processing-architecture-analysis.pdf` - Technical documentation
- `video_presentation_elgamil.pdf` - Project presentation

---

*This project demonstrates practical implementation of AWS serverless technologies and cloud architecture principles.*
